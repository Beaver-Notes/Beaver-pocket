...
const App: React.FC = () => {
  ...
  const toggleTheme = (newMode: boolean | ((prevState: boolean) => boolean)) => {
    setDarkMode(newMode);
              ...
              <div className="py-4">
                ...
                {notesList.length === 0 && (
                  <div className="mx-auto">
                    <svg className="max-w-auto mx-auto flex justify-center items-center" viewBox="0 0 295 301" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M229.148 21C229.161 21 229.172 21.0098 229.173 21.0227C229.389 23.0223 230.978 24.6105 232.977 24.8267C232.99 24.8281 233 24.8389 233 24.8519C233 24.8648 232.99 24.8756 232.977 24.877C230.873 25.1044 229.225 26.851 229.151 28.9975C229.151 28.9989 229.15 29 229.148 29C229.147 29 229.146 28.9989 229.146 28.9975C229.068 26.7445 227.256 24.9321 225.003 24.8544C225.001 24.8544 225 24.8533 225 24.8519C225 24.8505 225.001 24.8493 225.003 24.8493C227.149 24.7753 228.896 23.1267 229.123 21.0227C229.124 21.0098 229.135 21 229.148 21Z" fill="#E3E3E3" />
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M207.074 0C207.124 0 207.166 0.0381398 207.171 0.0878592C208.009 7.83642 214.164 13.9909 221.912 14.8287C221.962 14.834 222 14.8759 222 14.9259C222 14.9759 221.962 15.0178 221.912 15.0232C213.759 15.9047 207.371 22.6726 207.084 30.9902C207.084 30.9956 207.079 31 207.074 31C207.069 31 207.064 30.9956 207.064 30.9902C206.763 22.2599 199.74 15.2369 191.01 14.936C191.004 14.9358 191 14.9313 191 14.9259C191 14.9205 191.004 14.9161 191.01 14.9159C199.327 14.6292 206.095 8.24098 206.977 0.0878763C206.982 0.0381569 207.024 0 207.074 0Z" fill="#E3E3E3" />
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M291.148 202C291.161 202 291.172 202.01 291.173 202.023C291.389 204.022 292.978 205.611 294.977 205.827C294.99 205.828 295 205.839 295 205.852C295 205.865 294.99 205.876 294.977 205.877C292.873 206.104 291.225 207.851 291.151 209.997C291.151 209.999 291.15 210 291.148 210C291.147 210 291.146 209.999 291.146 209.997C291.068 207.744 289.256 205.932 287.003 205.854C287.001 205.854 287 205.853 287 205.852C287 205.85 287.001 205.849 287.003 205.849C289.149 205.775 290.896 204.127 291.123 202.023C291.124 202.01 291.135 202 291.148 202Z" fill="#E3E3E3" />
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M267.074 182C267.124 182 267.166 182.038 267.171 182.088C268.009 189.836 274.164 195.991 281.912 196.829C281.962 196.834 282 196.876 282 196.926C282 196.976 281.962 197.018 281.912 197.023C273.759 197.905 267.371 204.673 267.084 212.99C267.084 212.996 267.079 213 267.074 213C267.069 213 267.064 212.996 267.064 212.99C266.763 204.26 259.74 197.237 251.01 196.936C251.004 196.936 251 196.931 251 196.926C251 196.921 251.004 196.916 251.01 196.916C259.327 196.629 266.095 190.241 266.977 182.088C266.982 182.038 267.024 182 267.074 182Z" fill="#E3E3E3" />
                      <path d="M153 238H196V279.5C196 291.374 186.374 301 174.5 301C162.626 301 153 291.374 153 279.5V238Z" fill="#E07C2F" />
                      <path d="M113 238H156V279.5C156 291.374 146.374 301 134.5 301C122.626 301 113 291.374 113 279.5V238Z" fill="#EFA432" />
                      <path d="M237.853 197.503L213 162.412L246.866 138.426C256.556 131.563 269.975 133.855 276.838 143.545C283.701 153.235 281.409 166.654 271.719 173.517L237.853 197.503Z" fill="#E37C2D" />
                      <path d="M201.017 40.4287C209.706 29.6985 225.448 28.0439 236.178 36.733C246.908 45.4221 248.563 61.1645 239.874 71.8947L239.357 72.5328C235.767 76.9658 229.264 77.6494 224.831 74.0596L202.027 55.5933C197.594 52.0035 196.91 45.4998 200.5 41.0667L201.017 40.4287Z" fill="#B36028" />
                      <path d="M9.9529 176.835C-4.38048 159.753 -2.15242 134.286 14.9294 119.953C32.0113 105.619 57.4784 107.848 71.8118 124.929L124.828 188.112L62.9692 240.018L9.9529 176.835Z" fill="#B55E28" />
                      <path d="M56 117.5C56 65.3091 98.3091 23 150.5 23C202.691 23 245 65.3091 245 117.5V199C245 237.66 213.66 269 175 269H56V117.5Z" fill="#EFA432" />
                      <path d="M55.9803 227.013L98.9803 226.987L99.0063 268.487C99.0137 280.361 89.3938 289.993 77.5197 290C65.6456 290.007 56.0137 280.388 56.0063 268.513L55.9803 227.013Z" fill="#EFA431" />
                      <path d="M62.7263 71.9254C54.0372 61.1952 55.6918 45.4528 66.4219 36.7637C77.1521 28.0746 92.8945 29.7292 101.584 40.4593L102.1 41.0974C105.69 45.5304 105.007 52.0342 100.574 55.624L77.7696 74.0902C73.3366 77.68 66.8328 76.9965 63.243 72.5634L62.7263 71.9254Z" fill="#B36028" />
                      <rect x="121" y="172" width="107" height="83" rx="41.5" fill="#FAE3B7" />
                      <rect x="173" y="236.761" width="16.6588" height="2.37983" transform="rotate(-50 173 236.761)" fill="#EFA432" />
                      <rect x="174.823" y="224" width="16.6588" height="2.37983" transform="rotate(50 174.823 224)" fill="#EFA432" />
                      <rect x="119" y="83" width="15" height="10" rx="5" fill="#B75C25" />
                      <rect x="183" y="83" width="15" height="10" rx="5" fill="#B75C25" />
                      <ellipse cx="127" cy="109" rx="8" ry="11" fill="#562001" />
                      <ellipse cx="191" cy="109" rx="8" ry="11" fill="#562001" />
                      <path d="M155 142H166V149.5C166 152.538 163.538 155 160.5 155C157.462 155 155 152.538 155 149.5V142Z" fill="#FBFCFF" />
                      <path d="M166 142H177V149.5C177 152.538 174.538 155 171.5 155C168.462 155 166 152.538 166 149.5V142Z" fill="#FBFCFF" />
                      <rect x="135" y="126" width="62" height="20" rx="10" fill="#FAE5B8" />
                      <path d="M157 127.333C157 124.94 158.94 123 161.333 123H170.667C173.06 123 175 124.94 175 127.333C175 132.12 171.12 136 166.333 136H165.667C160.88 136 157 132.12 157 127.333Z" fill="#B45F28" />
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M21.1481 71C21.161 71 21.1719 71.0098 21.1732 71.0227C21.3895 73.0223 22.9777 74.6105 24.9773 74.8267C24.9902 74.8281 25 74.8389 25 74.8519C25 74.8648 24.9902 74.8756 24.9773 74.877C22.8733 75.1044 21.2247 76.851 21.1507 78.9975C21.1507 78.9989 21.1495 79 21.1481 79C21.1467 79 21.1456 78.9989 21.1455 78.9975C21.0679 76.7445 19.2555 74.9321 17.0025 74.8544C17.0011 74.8544 17 74.8533 17 74.8519C17 74.8505 17.0011 74.8493 17.0025 74.8493C19.149 74.7753 20.8955 73.1267 21.123 71.0227C21.1244 71.0098 21.1352 71 21.1481 71Z" fill="#E3E3E3" />
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M39.074 75C39.124 75 39.166 75.0381 39.1713 75.0879C40.0091 82.8364 46.1636 88.9909 53.9122 89.8287C53.9619 89.834 54 89.8759 54 89.9259C54 89.9759 53.9619 90.0178 53.9121 90.0232C45.759 90.9047 39.3708 97.6726 39.0841 105.99C39.0839 105.996 39.0795 106 39.074 106C39.0686 106 39.0642 105.996 39.064 105.99C38.7631 97.2599 31.7401 90.2369 23.0098 89.936C23.0043 89.9358 23 89.9313 23 89.9259C23 89.9205 23.0043 89.9161 23.0098 89.9159C31.3273 89.6292 38.0952 83.241 38.9767 75.0879C38.9821 75.0382 39.024 75 39.074 75Z" fill="#E3E3E3" />
                    </svg>
