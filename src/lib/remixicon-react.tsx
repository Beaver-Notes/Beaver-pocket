...
const Backward5Line: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
...
const iCloud: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    id="Capa_1"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="-18.26 -18.26 340.83 340.83"
    stroke="currentColor"
    stroke-width="15"
  >
...
const GDrive: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    viewBox="0 0 24 24"
    fill="currentColor"
    className={className}
...
const OneDrive: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    fill="currentColor"
    className={className}
    viewBox="0 0 32 32"
